...
| `transportInstance` | `SmsTransport` | — | A pre-built transport instance (takes precedence over `transport`). Use for transports needing constructor args, e.g. a [resilient failover transport](#multi-provider-failover). |
