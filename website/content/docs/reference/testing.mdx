---
title: Testing
description: Assert what your code would send without delivering anything. The @nestjs-notifications/testing package gives you a NotificationFake with Laravel-style assertions and a RecordingChannel for end-to-end tests.
---

import { Tab, Tabs } from 'fumadocs-ui/components/tabs';
import { Callout } from 'fumadocs-ui/components/callout';

Tests shouldn't send real emails. The `@nestjs-notifications/testing` package gives you two test
...
<Tabs items={['pnpm', 'npm']}>
  <Tab value="pnpm">
    ```bash
    pnpm add -D @nestjs-notifications/testing
    ```
  </Tab>
  <Tab value="npm">
    ```bash
    npm install -D @nestjs-notifications/testing
    ```
  </Tab>
</Tabs>
...
import { provideNotificationFake, NotificationFake } from '@nestjs-notifications/testing';
...
```ts
import { ChannelRegistry } from '@nestjs-notifications/core';
import { RecordingChannel } from '@nestjs-notifications/testing';
