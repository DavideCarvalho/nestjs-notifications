...
<Tabs items={['pnpm', 'npm']}>
  <Tab value="pnpm">
    ```bash
    pnpm add @nestjs-notifications/event-emitter @nestjs/event-emitter
    ```
  </Tab>
  <Tab value="npm">
    ```bash
    npm install @nestjs-notifications/event-emitter @nestjs/event-emitter
    ```
  </Tab>
</Tabs>
...
import { EventEmitterDispatcher } from '@nestjs-notifications/event-emitter';
