...
<Callout type="info">
  ...
  exactly. If you generate typed clients with `nestjs-codegen`, the controller is a clean target — a
  future generator could emit this client straight from your routes.
</Callout>
