...
`@nestjs-notifications/telescope` package ships a watcher that plugs straight in. It works by
...
<Tabs items={['pnpm', 'npm']}>
  <Tab value="pnpm">
    ```bash
    pnpm add @nestjs-notifications/telescope @dudousxd/nestjs-telescope
    ```
  </Tab>
  <Tab value="npm">
    ```bash
    npm install @nestjs-notifications/telescope @dudousxd/nestjs-telescope
    ```
  </Tab>
</Tabs>
...
import { NotificationsWatcher } from '@nestjs-notifications/telescope';
